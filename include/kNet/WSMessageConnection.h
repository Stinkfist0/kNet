...
/** @file WSMessageConnection.h
	@brief The WSMessageConnection class.*/
...
class WSMessageConnection : public MessageConnection
{
public:
	WSMessageConnection(Network *owner, NetworkServer *ownerServer, Socket *socket, ConnectionState startingState);
	~WSMessageConnection();
